...
class ProductController extends Controller
{
    ...
    public function store(Request $request)
    {
        $validated = $request->validate([
            ...
            'variants.*.attribute_values.*' => 'exists:attribute_values,value_id',
                    ...
                    if (isset($variantData['variant_id'])) {
                        ...
                        if (in_array($variantData['variant_id'], $existingVariantIds)) {
                            ...
                            $variant->update([
                                ...
                                'main_image_url' => $variantData['main_image_url'] ?? ($variant->main_image_url),
                            ]);
                        ...
                        if (isset($variantData['attribute_values']) && is_array($variantData['attribute_values'])) {
                            $newVariant->attributeValues()->sync($variantData['attribute_values']);
                        }
